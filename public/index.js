    ...
    if (
      ...
      switch (varuni3) {
        case "dub":
          ...
          break;
        case "geh":
          parcial = Math.pow(varcms, 0.42246);
          otro = Math.pow(varkilos, 0.51456);
          document.forms[0].resultado.value =
            Math.round(parcial * otro * 2.35) / 100;
          break;
        case "hay":
          parcial = Math.pow(varcms, 0.3964);
          otro = Math.pow(varkilos, 0.5378);
          document.forms[0].resultado.value =
            Math.round(parcial * otro * 2.4265) / 100;
          break;
        case "mos":
          parcial = (varcms * varkilos) / 3600;
          otro = Math.pow(parcial, 0.5);
          document.forms[0].resultado.value = Math.round(otro * 100) / 100;
          break;
        case "boy":
          vargr = varkilos * 1000;
          varlog = milog(vargr, 10);
          varexp = 0.7285 - 0.0188 * varlog;
          parcial = Math.pow(vargr, varexp);
          varotro = Math.pow(varcms, 0.3);
          otro = 0.0003207 * varotro * parcial;
          document.forms[0].resultado.value = Math.round(otro * 100) / 100;
          break;
      }
    }
